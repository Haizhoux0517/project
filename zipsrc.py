...
if __name__ == '__main__':
    ...
    argparser.add_argument("-s", "--srcfile", dest="src_file", default='toxic_comment.py', help="name of source file for homework")
    argparser.add_argument("-n", "--notebook", dest="notebook_file", default='toxic_comment.ipynb', help="name of iPython notebook for homework")
